##this wasn't finished as cifar needed resize to use pretrained resnet on imagenet..
...
datafold='/Users/yuewu/Dropbox (Edison_Lab@UGA)/Projects/Bioinformatics_modeling/data/cifar/'
listmodelfile={
...
def main_worker(gpu,ngpus_per_node,args):
    ...
    trainset=torchvision.datasets.CIFAR10(root=datafold, train=True,
                                        download=True,transform=transform)
    trainloader=torch.utils.data.DataLoader(trainset, batch_size=4,
                                              shuffle=True, num_workers=2)

    testset = torchvision.datasets.CIFAR10(root=datafold, train=False,
                                           download=True, transform=transform)
    ...
    model_ft.to(device)
    optimizer=optim.adam(model_ft.parameters(),lr=args.learning_rate,momentum=args.momentum)
    ## lr decay scheduler
